...
fun main(args: Array<String>) {
    ...
    val calculator = ReactiveCalculatorCoroutine(15, 10)
...
class ReactiveCalculatorCoroutine(a: Int, b: Int) {
    internal val subjectCalc: Subject<ReactiveCalculatorCoroutine> = PublishSubject.create()
