...
public class TestData {
  ...
  public static final Plane PLANE_WITH_ID =
      Plane.builder().id(PLANE_ID).code(CODE).type(TYPE).build();
  public static final Plane PLANE_WITH_ID_2 =
      Plane.builder().id(PLANE_ID_2).code(CODE).type(TYPE).build();
  ...
  public static final Flight FLIGHT =
      Flight.builder().plane(PLANE).origin(POA).destination(CNH).build();

  public static final Flight FLIGHT_WITH_ID =
      Flight.builder()
          .id(FLIGHT_ID)
          .plane(PLANE_WITH_ID)
          .origin(POA)
  ...
  public static final Flight FLIGHT_WITH_ID_2 =
      Flight.builder()
          .id(FLIGHT_ID_2)
          .plane(PLANE_WITH_ID)
          .origin(CNH)
