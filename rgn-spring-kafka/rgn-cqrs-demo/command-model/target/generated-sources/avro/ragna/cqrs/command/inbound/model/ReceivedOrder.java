 ...
 */
package ragna.cqrs.command.inbound.model;
...
public class ReceivedOrder extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 727001598116499713L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"ReceivedOrder\",\"namespace\":\"ragna.cqrs.command.inbound.model\",\"fields\":[{\"name\":\"orderId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"customerId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"itemLabel\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"itemPrice\",\"type\":\"double\"},{\"name\":\"ts_received\",\"type\":\"long\",\"default\":0}]}");
   ...
   */
  public static ragna.cqrs.command.inbound.model.ReceivedOrder.Builder newBuilder() {
    return new ragna.cqrs.command.inbound.model.ReceivedOrder.Builder();
  }
   ...
   * @return A new ReceivedOrder RecordBuilder
   */
  public static ragna.cqrs.command.inbound.model.ReceivedOrder.Builder newBuilder(ragna.cqrs.command.inbound.model.ReceivedOrder.Builder other) {
    if (other == null) {
      return new ragna.cqrs.command.inbound.model.ReceivedOrder.Builder();
    } else {
      return new ragna.cqrs.command.inbound.model.ReceivedOrder.Builder(other);
    }
  }
   ...
   * @return A new ReceivedOrder RecordBuilder
   */
  public static ragna.cqrs.command.inbound.model.ReceivedOrder.Builder newBuilder(ragna.cqrs.command.inbound.model.ReceivedOrder other) {
    if (other == null) {
      return new ragna.cqrs.command.inbound.model.ReceivedOrder.Builder();
    } else {
      return new ragna.cqrs.command.inbound.model.ReceivedOrder.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ReceivedOrder>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(ragna.cqrs.command.inbound.model.ReceivedOrder.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(ragna.cqrs.command.inbound.model.ReceivedOrder other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.orderId)) {
        this.orderId = data().deepCopy(fields()[0].schema(), other.orderId);
    ...
    /**
      ...
      * @return This builder.
      */
    public ragna.cqrs.command.inbound.model.ReceivedOrder.Builder setOrderId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ragna.cqrs.command.inbound.model.ReceivedOrder.Builder clearOrderId() {
      orderId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public ragna.cqrs.command.inbound.model.ReceivedOrder.Builder setCustomerId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ragna.cqrs.command.inbound.model.ReceivedOrder.Builder clearCustomerId() {
      customerId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public ragna.cqrs.command.inbound.model.ReceivedOrder.Builder setItemLabel(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ragna.cqrs.command.inbound.model.ReceivedOrder.Builder clearItemLabel() {
      itemLabel = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public ragna.cqrs.command.inbound.model.ReceivedOrder.Builder setItemPrice(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ragna.cqrs.command.inbound.model.ReceivedOrder.Builder clearItemPrice() {
    ...
    /**
      ...
      * @return This builder.
      */
    public ragna.cqrs.command.inbound.model.ReceivedOrder.Builder setTsReceived(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ragna.cqrs.command.inbound.model.ReceivedOrder.Builder clearTsReceived() {
